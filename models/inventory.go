...
type InventoryItem struct {
	...
	Restocks    []Restock `gorm:"foreignKey:ItemID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE;" json:"-" swaggerignore:"true"` // One-to-Many relationship, ignored in Swagger
}
